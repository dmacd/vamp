...
from apm.experiments.vamp_logt_integrator_ceiling_permuted_reporting import write_results
from apm.experiments.vamp_logt_integrator_ceiling_permuted_workflow import run_phase_seed
...
def test_two_step_ceiling_uses_disjoint_validation_and_resumes_exactly(
    ...
    monkeypatch.setattr(
        "apm.experiments.vamp_logt_integrator_ceiling_permuted_workflow.build_benchmark",
