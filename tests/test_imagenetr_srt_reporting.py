...
def test_complete_synthetic_report_layout(tiny_full_stream, tmp_path) -> None:
    ...
    analyses = {
        ...
        for condition in reporting.NEW_STYLES
    }
    ...
    figures = {
        ...
        "timelines": reporting._plot_timelines(reports, timelines),
    }
