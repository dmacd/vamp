"""Entry point for the converged Rotated-MNIST integrator ceiling."""
...
from apm.experiments.vamp_logt_integrator_ceiling_rotated_workflow import run_workflow
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Converged full-replay LogT integrator ceiling on Rotated-MNIST"
    )
    ...
    print(f"Rotated integrator-ceiling artifacts: {result}", flush=True)
