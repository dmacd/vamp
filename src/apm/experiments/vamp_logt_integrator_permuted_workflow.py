"""Resumable direct-prediction integration on Permuted-MNIST."""
...
def run_workflow(
    ...
    print(f"Durable Permuted-MNIST prediction-integrator run: {run_root}", flush=True)
...
def _write_protocol(
    ...
    material_paths = (
        ...
        "src/apm/experiments/vamp_logt_integrator_permuted_mnist.py",
        "src/apm/experiments/vamp_logt_integrator_permuted_reporting.py",
        "src/apm/experiments/vamp_logt_integrator_permuted_workflow.py",
