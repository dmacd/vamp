"""Strict configuration for the converged Rotated-MNIST integrator ceiling."""
...
class VampLogTIntegratorCeilingConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            self.name != "vamp-logt-converged-integrator-ceiling-rotated-mnist"
            or self.protocol_revision != "integrated-prediction-ceiling-v1"
    ...
    @property
    def task(self) -> RotatedTaskConfig:
        """Expose the parent's Rotated-MNIST task."""
