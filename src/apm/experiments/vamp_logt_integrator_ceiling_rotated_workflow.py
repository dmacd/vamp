"""Resumable converged full-replay integrator ceiling on Rotated-MNIST."""
...
from apm.experiments.vamp_logt_integrator_ceiling_rotated_reporting import (
    write_phase_report,
    write_results,
)
...
def run_workflow(
    ...
    print(f"Durable Rotated-MNIST integrator ceiling: {run_root}", flush=True)
...
def _write_protocol(
    ...
    material_paths = (
        ...
        "docs/logt_vamp_rotated_mnist_converged_integrator_ceiling_plan.md",
        ...
        "src/apm/experiments/vamp_logt_integrator_ceiling_rotated_config.py",
        "src/apm/experiments/vamp_logt_integrator_ceiling_rotated_mnist.py",
        "src/apm/experiments/vamp_logt_integrator_ceiling_rotated_reporting.py",
        "src/apm/experiments/vamp_logt_integrator_ceiling_rotated_workflow.py",
