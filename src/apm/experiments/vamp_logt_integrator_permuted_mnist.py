"""Entry point for direct LogT prediction integration on Permuted-MNIST."""
...
from apm.experiments.vamp_logt_integrator_permuted_reporting import rerender_results
from apm.experiments.vamp_logt_integrator_permuted_workflow import run_workflow


DEFAULT_CONFIG = Path("configs/vamp_logt_integrator_permuted_mnist/primary.yaml")
CEILING_ARTIFACT_DIRECTORY = "vamp-logt-integrator-ceiling-permuted-mnist"
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Direct LogT prediction integration on Permuted-MNIST"
    )
    ...
    print(f"Permuted prediction-integrator artifacts: {result}", flush=True)
