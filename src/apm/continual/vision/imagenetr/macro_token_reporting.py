...
@media print {{ body {{ background:white; }} main {{ margin:0; max-width:none; padding:0; box-shadow:none; }} details {{ break-inside:avoid; }} details > * {{ display:block; }} summary {{ display:none; }} .print-page {{ break-before:page; }} figure.lineage {{ margin:10px 0; }} figure.lineage img {{ display:block; width:88%; margin:0 auto; }} details.print-compact {{ margin:10px 0; padding:6px 10px; font-size:12px; line-height:1.35; }} details.print-compact p {{ margin:6px 0; }} details.print-compact table {{ margin:6px 0; font-size:10.5px; }} details.print-compact th, details.print-compact td {{ padding:4px 5px; }} .screen-only {{ display:none; }} }}
